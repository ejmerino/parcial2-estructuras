...
/*Comprobamos si el arbol esta vacio, si ese es el caso creamos un nuevo nodo e igualamos el arbol al nuevo nodo. Si el arbol cuenta con algén dato entonces creamos una variable llamanda raiz para obtener si valor y establecer si el nuevo element va a la derecha o a la izquierda*/
...
/*Para buscar un elemento comprobamos si el arbol está vacío, caso contrario verificamos el nodo a ver si es el dato buscado, si este es menor buscamos a la derecha y si es mayor lo buscamos a la izquierda*/
